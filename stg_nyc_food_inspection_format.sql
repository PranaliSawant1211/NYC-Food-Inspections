...
/****** Object:  Table [dbo].[stg_nyc_foodInspection_format]    Script Date: 13-02-2023 22:45:38 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[stg_nyc_foodInspection_format](
	[CAMIS] [int] NULL,
	...
	[InspectionDate_DF] [date] NULL,
	[GradeDate_DF] [date] NULL,
	[RecordDate_DF] [date] NULL
) ON [PRIMARY]
GO
